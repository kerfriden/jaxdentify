"""
Test Gaussian Variational Inference on 2D Banana distribution.
"""
...
def plot_banana_with_samples(samples, b=2.0, sigma=0.12, filename="plots/gaussian_vi_banana.png", 
                            title_prefix="Gaussian VI", n_func_evals=0, n_grad_evals=0):
