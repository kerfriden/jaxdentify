...
from optimization.optimizers import bfgs, bfgs_fd, adamw, cma_es
...
print("loss(theta0):",loss(theta0))


print('running BFGS')
t0 = time.perf_counter()
theta_opt, f_bfgs, info = bfgs(loss, theta0, max_iter=100, gtol=1e-12,rtol=1.e-3)
t1 = time.perf_counter()
print("time for optimization:", (t1 - t0), "s")
print(f"[BFGS autodiff]   loss = {f_bfgs:.3e}")
print("info",info)
...
print('running BFGS - no autodiff')
t0 = time.perf_counter()
theta_opt, f_bfgs, info = bfgs_fd(loss, theta0, max_iter=100, gtol=1e-12,rtol=1.e-3)
t1 = time.perf_counter()
print("time for optimization:", (t1 - t0), "s")
print(f"[BFGS perturbation]   loss = {f_bfgs:.3e}")
print("info",info)
...
print('running adamw')
t0 = time.perf_counter()
theta_opt, f_bfgs, info = adamw(loss, theta0, max_iter=10000, gtol=1e-12,rtol=1.e-3)
t1 = time.perf_counter()
print("time for optimization:", (t1 - t0), "s")
print(f"[adamw]   loss = {f_bfgs:.3e}")
print("info",info)
...
print('running cma_es')
t0 = time.perf_counter()
theta_opt, f_bfgs, info = cma_es(loss, theta0, max_iter=10000, gtol=1e-12,rtol=1.e-3)
t1 = time.perf_counter()
print("time for optimization:", (t1 - t0), "s")
print(f"[cma_es]   loss = {f_bfgs:.3e}")
print("info",info)
